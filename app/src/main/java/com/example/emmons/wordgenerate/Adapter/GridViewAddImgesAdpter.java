...
public class GridViewAddImgesAdpter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.activity_item_push_gird, parent, false);
    ...
    public class ViewHolder {
        ...
        public ViewHolder(View root) {
            ivimage = (ImageView) root.findViewById(R.id.pic_item_iv_image);
            btdel = (Button) root.findViewById(R.id.pic_item_bt_del);
            this.root = root;
        }
    }
}
